    ...
    <tr>
      <td align="center" width="50%" style="padding: 8px; background-color: #F9FAFB;">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="56" viewBox="0 0 600 56" role="img" aria-label="发送命令">
          ...
          <text x="300" y="37" text-anchor="middle" font-family="Microsoft YaHei, PingFang SC, Noto Sans CJK SC, Arial, sans-serif" font-size="22" font-weight="900" fill="#FFFFFF">🚀 发送命令</text>
        </svg>
      ...
      <td align="center" width="50%" style="padding: 8px; background-color: #F9FAFB;">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="56" viewBox="0 0 600 56" role="img" aria-label="打码显示">
          ...
          <text x="300" y="37" text-anchor="middle" font-family="Microsoft YaHei, PingFang SC, Noto Sans CJK SC, Arial, sans-serif" font-size="22" font-weight="900" fill="#FFFFFF">🎭 打码显示</text>
        </svg>
        <div style="height: 10px;"></div>
    ...
    <tr>
      <td align="center" width="50%" style="padding: 8px; background-color: #F3F4F6;">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="56" viewBox="0 0 600 56" role="img" aria-label="通知提醒">
          ...
          <text x="300" y="37" text-anchor="middle" font-family="Microsoft YaHei, PingFang SC, Noto Sans CJK SC, Arial, sans-serif" font-size="22" font-weight="900" fill="#FFFFFF">🔔 通知提醒</text>
        </svg>
        <div style="height: 10px;"></div>
      ...
      <td align="center" width="50%" style="padding: 8px; background-color: #F3F4F6;">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="56" viewBox="0 0 600 56" role="img" aria-label="Skill 列表管理">
          ...
          <text x="300" y="37" text-anchor="middle" font-family="Microsoft YaHei, PingFang SC, Noto Sans CJK SC, Arial, sans-serif" font-size="22" font-weight="900" fill="#FFFFFF">🧬 Skill 列表管理</text>
        </svg>
        <div style="height: 10px;"></div>
