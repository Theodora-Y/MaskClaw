...
<h4 style="font-family: Georgia, 'Times New Roman', serif; font-size: 1em; font-weight: bold; color: #555; border-left: 4px solid #bdc3c7; padding-left: 10px; margin-top: 1.2em;">发送命令</h4>

![发送命令](docs/assets.md/发送命令.gif)

<h4 style="font-family: Georgia, 'Times New Roman', serif; font-size: 1em; font-weight: bold; color: #555; border-left: 4px solid #bdc3c7; padding-left: 10px; margin-top: 1.2em;">打码显示</h4>

![打码显示](docs/assets.md/打码显示.gif)

<h4 style="font-family: Georgia, 'Times New Roman', serif; font-size: 1em; font-weight: bold; color: #555; border-left: 4px solid #bdc3c7; padding-left: 10px; margin-top: 1.2em;">通知提醒</h4>

![通知提醒](docs/assets.md/通知.gif)

<h4 style="font-family: Georgia, 'Times New Roman', serif; font-size: 1em; font-weight: bold; color: #555; border-left: 4px solid #bdc3c7; padding-left: 10px; margin-top: 1.2em;">Skill 列表管理</h4>
