...
<div align="center">
  ...
  <!-- Logo Area -->
  <div class="logo-area">
    <img src="assets/logoheng.svg" width="100%" alt="MaskClaw Logo" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" />
    <h1 class="logo-title" style="display: none;">MaskClaw</h1>
...
<div class="toc">
  ...
  <ul class="toc-list">
    ...
    <li class="toc-item"><a class="toc-link" href="#modules">🧩 四大核心模块</a></li>
...
<div align="center">
  <img src="assets/overview.svg" width="85%" alt="MaskClaw Overview" onerror="this.style.display='none'" />
</div>
...
<div class="module-grid">
  <div class="module-item">
    ...
    <div class="module-title">PII Detection</div>
    <div class="module-desc">
      隐私信息检测模块，负责识别图片中的格式化敏感信息。支持手机号、身份证号、银行卡号、
      家庭住址、姓名等信息的毫秒级识别。采用 PaddleOCR + Presidio 双引擎保障识别精度。
    </div>
  </div>
  ...
  <div class="module-item">
    ...
    <div class="module-desc">
      智能视觉打码模块，对敏感区域进行本地模糊处理。支持马赛克、高斯模糊、区域色块覆盖
      等多种打码方式。OpenCV 驱动的本地处理，保障数据不出端。
    </div>
  </div>
  ...
  <div class="module-item">
    ...
    <div class="module-desc">
      行为监控模块，持续监听 Agent 操作行为，捕获用户主动干预动作。包括修改填写值、
      拒绝某次操作等修正行为，为规则进化提供数据基础。
    </div>
  </div>
